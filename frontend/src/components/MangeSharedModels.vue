...
<template>
  ...
  >
    ...
    <template v-slot:item.title="{ item }">
      <v-form :ref="'title_' + item._id" class="mt-1">
      ...
      <v-form :ref="'description_' + item._id" class="mt-n2">
        <v-sheet class="d-flex">
          <v-text-field
            width="12em"
            density="compact"
      ...
      <td :colspan="columns.length">
        <v-table density="compact">
          <t-body>
            ...
            <v-row v-if="item.protection === 'Pin'">
              <v-col cols="12">
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { title: 'Title/Private Note', key: 'title', sortable: false, width: '20em'},
        { title: 'Date/Protection/Version', key: 'createdAt', sortable: true, width: '10em'},
